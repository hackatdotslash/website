...
<div class="container-fluid">
    <div class="row" style="margin: 15px; margin-top: 50px; margin-bottom: 20px;" >
        ...
        <div class="col-md-10 register-box">
            ...
            <form name="frmRegistration" class="" action="" method="POST">
                <div class="">
                    <div class="col-sm-6 register-field-label">
                        Team Name
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="">
                    ...
                    <div class="col-sm-6 register-radio-button">
