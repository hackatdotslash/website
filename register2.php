...
if (!empty($_POST["register-user"])) {
    ...
    if (!isset($error_message)) {
        ...
        $query = "SELECT teamName FROM registration WHERE p1Email = '".$_POST["p1Email"]."' OR p2Email = '".$_POST["p2Email"]."'";
    ...
    if (!isset($error_message)) {
        require_once("include/config.php");
        $db_handle = new DBController();
        $query = "INSERT INTO registration (teamName, p1Name, p1Email, p1College, p1Gender, p1Dob, p1Contact, p1Github, p1Linkedin, p1Twitter, p1Facebook, p2Name, p2Email, p2College, p2Gender, p2Dob, p2Contact, p2Github, p2Linkedin, p2Twitter, p2Facebook, newToHackathon, heardAboutHackathon, intrestedInWorkshop, specialNeeds) VALUES
