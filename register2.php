...
if (!empty($_POST["register-user"])) {
    ...
    if (!isset($error_message)) {
        ...
        $query = "SELECT teamName FROM registrationNew WHERE p1Email = '".$_POST["p1Email"]."' OR p2Email = '".$_POST["p2Email"]."'";
    ...
    if (!isset($error_message)) {
        ...
        //echo "Hi successfully";
            require_once("include/config.php");
        $db_handle = new DBController();
        $query = "INSERT INTO registrationNew (teamName, p1Name, p1Email, p1College, p1Gender, p1Dob, p1Contact, p1Github, p1Linkedin, p1Twitter, p1Facebook, p2Name, p2Email, p2College, p2Gender, p2Dob, p2Contact, p2Github, p2Linkedin, p2Twitter, p2Facebook, newToHackathon, heardAboutHackathon, intrestedInWorkshop, specialNeeds) VALUES
        ('" . $_POST["teamName"] . "', '" . $_POST["p1Name"] . "', '" . $_POST["p1Email"] . "', '" . $_POST["p1College"] . "', '" . $_POST["p1Gender"] . "', '" . $_POST["p1Dob"] . "', '" . $_POST["p1Contact"]. "', '" . $_POST["p1Github"]. "', '" . $_POST["p1Linkedin"]. "', '" . $_POST["p1Twitter"]. "', '" . $_POST["p1Facebook"]. "', '" . $_POST["p2Name"] . "', '" . $_POST["p2Email"] . "', '" . $_POST["p2College"] . "', '" . $_POST["p2Gender"] . "', '" . $_POST["p2Dob"] . "', '" . $_POST["p2Contact"]. "', '" . $_POST["p2Github"]. "', '" . $_POST["p2Linkedin"]. "', '" . $_POST["p2Twitter"]. "', '" . $_POST["p2Facebook"]. "', '" . $_POST["newToHackathon"]. "', '" . $_POST["heardAboutHackathon"]. "', '" . $_POST["intrestedInWorkshop"] . "', '" . $_POST["specialNeeds"] ."')";
...
<div class="container-width">
    <div class="row">
        ...
        <div class="col-md-8 col-lg-8 col-sm-8 col-xs-8 card">
            <div class="row register-header">
                <h1 class="col-md-12 col-sm-12 col-xs-12 col-lg-12">REGISTRATION FORM</h1>
                <p class="col-md-12 col-xs-12 col-sm-12 col-lg-12" style="text-align: left; font-size: 15px;"><span style="color: red">*</span> Mandatory Fields</p>
            </div>
            ...
            <form name="frmRegistration" class="row" action="" method="POST" data-toggle="validator">
                <div class="row">
                    <div class="col-md-3 col-lg-3 col-sm-3 col-xs-3 register-field-label">
                        Team Name<span style="color: red">*</span>
                    </div>
                    <div class="col-md-8 col-lg-8 col-sm-8 col-xs-8 col-lg-8 col-sm-8 col-xs-8">
